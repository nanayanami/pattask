...
# 概要
「あれ、あの案件いまどうなってたっけ…？」という、ビジネスマンが一度は経験する**“脳内パニック”**を解決するために開発しました。
 日々のタスクを整理し、ゴールまでの道のりを「見える化」することで、ユーザーを適切なスケジュールへと導きます。さらに、チーム内での進捗共有機能も搭載しました。
「誰が、どこで、止まっているか」がひと目でわかるため、マネージャーは催促という名の苦行から解放され、チームはスムーズな連携を手に入れることができます。

## サイトテーマ
「仕事の迷子をゼロにする。進捗可視化ツールPattask」
